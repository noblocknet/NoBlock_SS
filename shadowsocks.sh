...
echo "1、安装影梭插件"
echo "2、卸载影梭插件"
echo "3、安装ADbyby(屏蔽广告)插件"
echo "4、卸载ADbyby(屏蔽广告)插件"
echo "5、将官方Uboot替换不死Uboot,HC5661A专用，HC5661勿用(测试功能，请勿使用)"
echo "6、备份可备份的一切" 
echo "0、退出" 
read -n1 -p "请选择需要进行的操作[1-6、0]?" selectnum
echo ""
echo "---------------------------------------------------------"
case $selectnum in
